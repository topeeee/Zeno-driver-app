...
const OnlineBottomContent = () => {
    ...
    const renderPickUpDetails = () => {
        return (
            <View style={{ flex: 1 }}>
                <View style={{ height: 80, borderWidth: 0, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F7F7F7', borderRadius: 10, paddingHorizontal: 5 }}>
    ...
    return (
        <View style={{ marginTop: 30, backgroundColor: '#fff', flex: 1, borderRadius: 20, marginHorizontal: 20, overflow: 'hidden' }}>

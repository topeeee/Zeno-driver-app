...
import { bus, my_location, green_circle, circle_check, arrow_left } from "../../images";
...
const ReciptsModal = ({ dismiss }) => {
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.7)' }}>
            <View style={{ marginTop: 30, borderRadius: 20, marginHorizontal: 20, overflow: 'hidden', borderWidth: 1, paddingBottom: 20, backgroundColor: '#fff' }}>
